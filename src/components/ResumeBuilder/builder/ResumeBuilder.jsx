...
const ResumeBuilder = () => {
  ...
  return (
   ...
   <Navbar  style={{backgroundColor:'#232D3F'}} data-bs-theme="dark">
      <Container>
        <Navbar.Brand href="https://myfuse.in/home"> <h1 style={{fontSize:'30px',fontWeight:'600' , letterSpacing:'0.8px'}}>MyFuse<span style={{color:'#f96f59'}}>.</span>In</h1> 
        ...
        <Nav.Link href="https://myfuse.in/home" style={{color:'white'}}>Home</Nav.Link>
        <Navbar.Toggle />
        
        <Navbar.Collapse className="justify-content-end">
          <Navbar.Text>
              Log in as: <a href="#login">Unknown</a>
          </Navbar.Text>
        </Navbar.Collapse>
      </Container>
    </Navbar>
