...
const Links = ({ profile }) => {
  ...
  return (
    <div style={{marginLeft:'.5rem'}}>   
          ...
          <div>
            <h5 style={{fontWeight:'bolder'}}> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSRPYE0s4NsELDPMOfalXtxB6iD1ekcaOKuYYXBRqasGOxA8woOAyp5V43D4XIE3AjWyzE&usqp=CAU"  style={{height:'2rem'}}/>  Personal Info</h5>
...
const Experience = ({ experience }) => {
  ...
  return (
      <>
    <h5 style={{fontWeight:'bolder'}}> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS6cNpG1W2077hhV_VtqsNO2aS8Vc3V6pSGoVle6hY-QV65TQedgV3Jtyg5BlEJyE77bdQ&usqp=CAU"  style={{height:'2rem'}}/>  Experience</h5>
...
const Projects = ({ projects }) => {
  ...
  return (
    <>
      <h5 style={{fontWeight:'bolder'}}> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSEcWMINhyEC4Z4lk-cNzkWhY7GEujHVthz9A&usqp=CAU"  style={{height:'2rem'}}/>  Projects</h5>
         <hr style={{marginTop:'-.5rem'}}/>
...
const Education = ({ education, settings }) => {
  ...
  return (
    <Section  settings={settings}>
      <h5 style={{fontWeight:'bolder'}}> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRK8NJXQXDroV4W4PbeM_CGlICaQkB7UUxazQ&usqp=CAU"  style={{height:'2rem'}}/>  Education</h5>
         <hr style={{marginTop:'-.5rem'}}/>
...
const ExtraCurriculars = ({ extraCurriculars, settings }) => {
  ...
  return (
    < >
        <h5 style={{fontWeight:'bolder'}}> <img src="data:image/png;base64,"  style={{height:'2rem'}}/>  ExtraCurriculars</h5>
         <hr style={{marginTop:'-.5rem'}}/>
...
const PORs = ({ pors, settings }) => {
  ...
  return (
    <>
       <h5 style={{fontWeight:'bolder'}}> <img src="data:image/png;base64,"  style={{height:'2rem'}}/>  Responsibility</h5>
         <hr style={{marginTop:'-.5rem'}}/>
      {pors?.map((por, index) => {
        return (
          <div className={styles.project} key={index}>
